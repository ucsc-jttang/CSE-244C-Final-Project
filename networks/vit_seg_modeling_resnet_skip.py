...
class PAM_Module(Module):
    ...
    def __init__(self, in_dim):
        ...
        temp_out_dim = in_dim//8
        if temp_out_dim==0:
            temp_out_dim = 1
        self.query_conv = nn.Conv2d(in_channels=in_dim, out_channels=temp_out_dim, kernel_size=1)
        self.key_conv = nn.Conv2d(in_channels=in_dim, out_channels=temp_out_dim, kernel_size=1)
...
class CANetHead(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(CANetHead, self).__init__()
        inter_channels = in_channels // 16
...
class PANetHead(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(PANetHead, self).__init__()
        inter_channels = in_channels // 16
